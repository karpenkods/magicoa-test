...
!(function (e) {
  ...
  "function" == typeof define && define.amd
    ...
    ? (module.exports = e())
    : ((o = window.Cookies),
      ((t = window.Cookies = e()).noConflict = function () {
  ...
  return (function e(a) {
    function d(e, o, t) {
      ...
      if (1 < arguments.length) {
        "number" == typeof (t = l({ path: "/" }, d.defaults, t)).expires &&
          ((r = new Date()).setMilliseconds(
            r.getMilliseconds() + 864e5 * t.expires
          ),
          (t.expires = r));
        try {
      ...
      for (
        ...
        try {
          if (
            ((u = a.read
              ? a.read(u, s)
              : a(u, s) || u.replace(c, decodeURIComponent)),
            this.json)
          )
            try {
              u = JSON.parse(u);
    ...
    return (
      ((d.get = d.set = d).getJSON = function () {
